...
# 3 total ammo, one already in gun and two bullets, one more than playable Davy
...
replaceitem entity @s weapon.offhand firework_rocket{display:{Name:'{"text":"Flintlock Ammo","color":"#CCBA5E","bold":true,"italic":false}'},HideFlags:127,Tags:["dj_flintlockammo"],Fireworks:{Flight:1b,Explosions:[{Type:4,Flicker:1b,Trail:1b,Colors:[I;16727813,16749059,16768256],FadeColors:[I;16760425,16768399,16776074,16770756]}]}} 2
