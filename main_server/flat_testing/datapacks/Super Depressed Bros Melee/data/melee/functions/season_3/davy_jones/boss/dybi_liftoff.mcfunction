...
execute if entity @a[team=Red,tag=dyfd_user,scores={DJ_FearDeath=..0}] as @e[tag=dyfd_victim_stand_red] run data modify entity @s Motion[1] set value 1.5d
...
execute if entity @a[team=Blue,tag=dyfd_user,scores={DJ_FearDeath=..0}] as @e[tag=dyfd_victim_stand_blue] run data modify entity @s Motion[1] set value 1.5d
